...
import { useNoticiasJuridicas } from '@/hooks/useNoticiasJuridicas';
import { ExternalLink, Globe, AlertCircle } from 'lucide-react';

export const NoticiasJuridicas = () => {
  const { noticias, loading, error } = useNoticiasJuridicas();
              ...
              <Card key={i} className="animate-pulse neomorphism-legal">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-gray-600 rounded-lg animate-legal-shimmer"></div>
                    <div className="flex-1">
                      <div className="h-4 bg-gray-600 rounded mb-2 animate-legal-shimmer"></div>
                      <div className="h-3 bg-gray-600 rounded w-3/4 animate-legal-shimmer"></div>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <div className="py-12 sm:py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold text-foreground mb-2">Erro ao carregar portais</h2>
